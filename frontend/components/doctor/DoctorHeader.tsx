...
import {
  ...
  ChevronDown, Stethoscope, CalendarDays, MessageSquare
} from 'lucide-react'
...
export default function DoctorHeader() {
  ...
  const notifications = [
    { id: 1, title: 'New Appointment', message: 'Sarah Johnson booked a checkup at 3:00 PM', time: '5 min ago', icon: CalendarDays, color: 'text-blue-500' },
    { id: 2, title: 'Lab Results', message: 'Lab results for Michael Chen are ready', time: '1 hour ago', icon: Stethoscope, color: 'text-emerald-500' },
    { id: 3, title: 'Message', message: 'New message from Emily Davis', time: '2 hours ago', icon: MessageSquare, color: 'text-amber-500' },
  ]
      ...
      <div className="px-4 lg:px-8 py-3">
        <div className="flex items-center justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Have a great day at work</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-emerald-500 rounded-full flex items-center justify-center text-white text-sm font-bold">
                  DR
                </div>
              ...
              <AnimatePresence>
                {showProfile && (
                  ...
                  >
                    <div className="p-3 border-b border-gray-100 dark:border-gray-700">
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Dr. Robert</p>
